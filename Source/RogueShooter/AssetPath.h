...
namespace AssetPath
{
	...
	namespace Blueprint
	{
		...
		const FString WBP_ServerItem_C = TEXT("/Script/UMGEditor.WidgetBlueprint'/Game/RogueShooter/Widgets/UWB_ServerItem.UWB_ServerItem_C'");
		const FString WBP_ServerBrowser_C = TEXT("/Script/UMGEditor.WidgetBlueprint'/Game/RogueShooter/Widgets/UWB_ServerBrowser.UWB_ServerBrowser_C'");
		const FString WBP_HostMenu_C = TEXT("/Script/UMGEditor.WidgetBlueprint'/Game/RogueShooter/Widgets/UWB_HostMenu.UWB_HostMenu_C'");
		const FString WBP_InfoPopup_C = TEXT("/Script/UMGEditor.WidgetBlueprint'/Game/RogueShooter/Widgets/UWB_InfoPopup.UWB_InfoPopup_C'");
		const FString WBP_LoadingScreen_C = TEXT("WidgetBlueprint'/Game/RogueShooter/Widgets/UWB_LoadingScreen.UWB_LoadingScreen_C'");
		const FString WBP_CharacterSelectionItem_C = TEXT("WidgetBlueprint'/Game/RogueShooter/Widgets/UWB_CharacterSelectionItem.UWB_CharacterSelectionItem_C'");
